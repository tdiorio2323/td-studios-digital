            ...
            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
              <Card>
                ...
                <CardContent>
                  ...
                  <p className="text-xs text-muted-foreground">
                    <span className="text-emerald-500">+15.2%</span> from last
                    month
                  </p>
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent>
                  ...
                  <p className="text-xs text-muted-foreground">
                    <span className="text-emerald-500">+12.1%</span> from last
                    month
                  </p>
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent>
                  ...
                  <p className="text-xs text-muted-foreground">
                    <span className="text-emerald-500">+8.3%</span> from last
                    month
                  </p>
                </CardContent>
              </Card>
                  ...
                  <TableBody>
                    {products.map((product) => (
                      <TableRow key={product.id}>
                        ...
                        <TableCell>
                          <span
                            className={product.stock < 15 ? "text-red-500" : ""}
                          >
                            {product.stock}
                          </span>
                        </TableCell>
            ...
            <div className="grid gap-6">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Update your brand details and preferences
                  </CardDescription>
                </CardHeader>
