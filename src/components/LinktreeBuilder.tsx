...
export const LinktreeBuilder = () => {
  ...
  const addButton = () => {
    setConfig((prev) => ({
      ...
      buttons: [
        ...prev.buttons,
        { label: "New Link", url: "https://", enabled: true },
      ],
    }));
  };
  ...
  return (
    <div className="min-h-screen p-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div
          className={`grid gap-6 ${showPreview ? "lg:grid-cols-2" : "max-w-2xl"}`}
        >
              ...
              <CardContent className="space-y-4">
                <div className="grid grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        updateConfig({ pageName: e.target.value })
                      }
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      updateConfig({ bgImageSrc: e.target.value })
                    }
