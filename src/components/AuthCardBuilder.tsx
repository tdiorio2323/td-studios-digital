...
const defaultConfig: AuthCardConfig = {
  ...
  buttons: [
    ...
    {
      label: "Instagram",
      url: "https://www.instagram.com/punkiez__/",
      enabled: true,
    },
  ...
  return (
    <AuthPage
      ...
      hideAuthForm={${config.hideAuthForm}}${
        config.extraImageSrc
          ? `
      extraImageSrc="${config.extraImageSrc}"`
          : ""
      }${
        config.bgImageSrc
          ? `
...
export const AuthCardBuilder = () => {
  ...
  const updateButton = (
    index: number,
    updates: Partial<(typeof config.buttons)[0]>
  ) => {
    setConfig((prev) => ({
      ...prev,
          ...
          <CardContent className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) =>
                  updateConfig({ bounceLogoSrc: e.target.value })
                }
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) =>
                  updateConfig({ extraImageSrc: e.target.value })
                }
            ...
            <div className="space-y-4">
              <div className="flex items-center space-x-2">
                <Switch
                  ...
                  onCheckedChange={(checked) =>
                    updateConfig({ showBounceOnMobile: checked })
                  }
                />
              ...
              <div className="flex items-center space-x-2">
                <Switch
                  ...
                  onCheckedChange={(checked) =>
                    updateConfig({ hideAuthForm: checked })
                  }
                />
              ...
              <div className="flex items-center space-x-2">
                <Switch
                  ...
                  onCheckedChange={(checked) =>
                    updateConfig({ hideExtraButtons: checked })
                  }
                />
            ...
            <div className="flex gap-2">
              ...
              <Button variant="secondary" onClick={createAuthPage}>
                Create Page
              </Button>
            </div>
          </CardContent>
