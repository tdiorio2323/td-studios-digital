        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="mt-6 text-xl text-white/70 max-w-3xl mx-auto">
              Strategy, performance, and story-first content engineered for
      ...
      <div className="mx-auto max-w-6xl px-6 pb-12 space-y-12">
        <div className="grid gap-6 md:grid-cols-3">
          <LuxeCard title="Conversion-Ready Landers">
            Story-driven sections, SEO-focused architecture, and instrumented
            funnels built for measurable wins.
          </LuxeCard>
          <LuxeCard title="Scalable Marketing Sites">
            Modular content models, CMS-ready components, and asset optimization
            that keeps teams shipping fast.
          </LuxeCard>
          <LuxeCard title="Product Ecosystems">
            Unified brand, docs, and support surfaces powered by design systems
            and enterprise-grade hosting.
          </LuxeCard>
        </div>

        <ProofStrip
          metric="Trusted by teams launching high-impact digital products"
          logos={[]}
        />

        <div className="mt-10 grid gap-6 md:grid-cols-2">
          <LuxeCard title="Everything tied to outcomes">
            We lead discovery, prototype reviews, and performance calibration
            alongside your marketing and product leads. Expect dependable
            handoff, documentation, and a roadmap for optimization.
          </LuxeCard>
          <LuxeCard title="Stack & operations">
            React, Next.js, Vite, Sanity, Contentful, Supabase, and bespoke
            integrations paired with analytics, QA, and experiment support.
          </LuxeCard>
        </div>
          ...
          <div className="flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
            <div className="space-y-3 max-w-2xl">
              ...
              <p className="text-neutral-300">
                Drop in results, screenshots, and narrative once your next
                flagship web engagement is ready to share. Use this block for
                ROI numbers, testimonial quotes, or before/after visuals.
              </p>
            </div>
