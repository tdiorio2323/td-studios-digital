  ...
  const contentPacks = [
    {
      ...
      price: "$199",
      description:
        "Lifestyle-focused content showcasing cannabis culture and community.",
    ...
    },
    {
      ...
      price: "$179",
      description:
        "Educational content about different strains and their effects.",
    ...
    },
    {
      ...
      price: "$169",
      description:
        "Informative content about cannabis benefits and usage tips.",
    ...
    },
    {
      ...
      price: "$189",
      description:
        "Event promotion and coverage content for cannabis festivals.",
    ...
    },
    {
      ...
      price: "$139",
      description:
        "Templates for showcasing customer reviews and testimonials.",
      tags: ["Posts", "Stories"],
      ...
      <div className="container mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-white/70 max-w-3xl mx-auto mb-8">
            Ready-to-use social media content packs designed specifically for
            cannabis brands. Professional posts, reels, and stories that engage
            ...
            {[
              {
                ...
                description:
                  "Professional designs optimized for each social media platform.",
                icon: (
                  <svg
              ...
              },
              {
                ...
                description:
                  "Content that's ready to publish with suggested captions included.",
                icon: (
                  <svg
                    className="w-8 h-8 text-white"
                    fill="none"
              ...
              },
              {
                ...
                description:
                  "Posts, stories, reels, and banners in various sizes and formats.",
                icon: (
                  <svg
                    className="w-8 h-8 text-white"
                    fill="none"
        ...
        <div className="max-w-4xl mx-auto text-center">
          <div className="p-12 bg-gradient-to-r from-white/10 to-white/5 backdrop-blur-lg border border-white/20 rounded-2xl">
            ...
            <p className="text-xl text-white/70 mb-8 max-w-2xl mx-auto">
              Our team can create custom social media content tailored
              specifically to your brand voice and audience.
            </p>
