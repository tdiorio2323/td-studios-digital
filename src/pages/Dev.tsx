        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="mt-6 text-xl text-white/70 max-w-3xl mx-auto">
              Strategy, engineering, and design collaborating to deliver
              performant digital products.
            </p>
            <div className="mt-8">
      ...
      <div className="mx-auto max-w-6xl px-6 pb-12 space-y-12">
        <div className="grid gap-6 md:grid-cols-3">
          <LuxeCard title="Product Discovery">
            Rapid architecture mapping, user flows, and proof-of-concept builds
            to de-risk your roadmap and align teams quickly.
          </LuxeCard>
          <LuxeCard title="Full-stack Delivery">
            TypeScript-first stacks, API design, data modeling, automated QA,
            and CI/CD across web and mobile surfaces.
          </LuxeCard>
          <LuxeCard title="Growth & Iteration">
            Analytics instrumentation, experiment support, and performance
            tuning to sustain shipping velocity post-launch.
          </LuxeCard>
        </div>

        <ProofStrip
          metric="Preferred engineering partner for premium consumer and B2B launches"
          logos={[]}
        />
        ...
        <div className="grid gap-6 md:grid-cols-2">
          ...
          >
            React, Next.js, Vite, Expo, Supabase, PostgreSQL, serverless edge,
            plus observability and error budgets by default.
          </LuxeCard>
          <LuxeCard
          ...
          <div className="flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
            <div className="space-y-3 max-w-2xl">
              <h3 className="text-2xl font-semibold tracking-tight text-white">
                Engineering case study placeholder
              </h3>
              <p className="text-neutral-300">
                Swap in client logos, throughput metrics, or screenshots.
                Highlight latency improvements, revenue impact, or feature
                velocity gains from a recent engagement.
              </p>
            </div>
