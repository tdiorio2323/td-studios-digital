...
const CustomDesignForm: React.FC = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    alert(
      "Thank you for your custom design request! We'll review your requirements and get back to you within 24 hours."
    );
  };
      ...
      <div className="container mx-auto max-w-4xl">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-white/70 max-w-3xl mx-auto">
            Let's bring your vision to life. Tell us about your custom design
            project and we'll create something extraordinary for your brand.
          </p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <div className="pt-6">
              ...
              <p className="text-center text-white/60 text-sm mt-4">
                We'll review your request and provide a detailed quote and
            ...
            {[
              {
                ...
                title: "Consultation",
                description:
                  "We discuss your vision, goals, and requirements in detail.",
                icon: (
                  <svg
              ...
              },
              {
                ...
                description:
                  "You receive all final files and assets in multiple formats.",
                icon: (
                  <svg
                    className="w-8 h-8 text-white"
                    fill="none"
              ...
              >
                ...
                <div className="text-sm text-white/60 font-bold mb-2">
                  STEP {item.step}
                </div>
