            ...
            {[
              {
                ...
                description:
                  "Marketing sites, landers, and product stories engineered for clarity and conversion.",
                cta: "Explore Web →",
                to: "/web",
              },
              {
                ...
                description:
                  "Application architecture, dashboards, and feature delivery for scale.",
                cta: "View Dev →",
                to: "/dev",
              },
              {
                ...
                description:
                  "Editorial programming, campaign kits, and community ops that sustain growth.",
                cta: "See Social →",
                to: "/social",
              },
              {
                ...
                description:
                  "Design systems, visual identity, and asset libraries crafted to travel everywhere.",
                cta: "Custom Design →",
                to: "/custom-designs",
              },
              {
                ...
                description:
                  "Ready-to-use content packs, templates, and downloads to accelerate launches.",
                cta: "Browse Assets →",
                to: "/digital-assets",
              },
              {
                ...
                title: "Partnerships",
                description:
                  "Referral alliances and white-label collaborations for agencies and founders.",
                cta: "Partnerships →",
                to: "/referral",
              },
          ...
          <div className="max-w-4xl mx-auto text-center">
            <LiquidGlassCard className="p-12 border border-white/20">
              ...
              <p className="text-xl text-white/70 mb-8 max-w-2xl mx-auto">
                ...
                discuss your premium design needs.
              </p>
            </LiquidGlassCard>
          </div>
        </div>
