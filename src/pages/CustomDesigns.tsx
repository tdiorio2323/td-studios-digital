  ...
  const services = [
    {
      title: "Logo Design",
      description:
        "Professional brand identity creation with multiple concepts and revisions.",
    ...
    },
    {
      ...
      description:
        "Custom packaging solutions for cannabis products, mylar bags, and containers.",
    ...
    },
    {
      ...
      description:
        "Flyers, banners, social media graphics, and promotional materials.",
  ...
  const process = [
    {
      ...
      title: "Discovery",
      description:
        "We start with understanding your brand, vision, and project requirements.",
    },
    {
      step: "02",
      title: "Concept",
      description:
        "Our team creates initial concepts and presents them for your feedback.",
    },
    {
      step: "03",
      title: "Refinement",
      description:
        "We refine the chosen concept based on your input and preferences.",
    },
    {
      step: "04",
      title: "Delivery",
      description:
        "Final files are delivered in all required formats with documentation.",
    },
  ];
      ...
      <div className="container mx-auto">
        ...
        <section className="mb-16">
          <div className="text-center mb-8">
            ...
            <p className="text-white/60 mt-2">
              Tap a card on mobile, hover on desktop.
            </p>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 place-items-center">
            <CardFlip
              title="Brief"
              subtitle="Tell us goals"
              description="We align on brand, audience, and outcomes."
              features={["Brand", "Audience", "Goals", "Scope"]}
              trigger="both"
            />
            <CardFlip
              title="Design"
              subtitle="Explore options"
              description="Rapid iterations with your feedback loop."
              features={["Concepts", "Variants", "Feedback", "Refine"]}
              trigger="both"
            />
            <CardFlip
              title="Deliver"
              subtitle="Ready to use"
              description="Final assets, guidelines, and files packaged."
              features={["Exports", "Guides", "Handoffs", "Support"]}
              trigger="both"
            />
          </div>
        </section>
        ...
        <div className="text-center mb-20">
          ...
          <p className="text-xl text-white/70 max-w-3xl mx-auto mb-8">
            From concept to completion, we create bespoke designs that elevate
            your cannabis brand to luxury status. Every project is crafted with
