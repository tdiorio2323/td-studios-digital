        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="mt-6 text-xl text-white/70 max-w-3xl mx-auto">
              Story-driven content, community programming, and campaigns that
              keep your brand in the feed.
            </p>
            <div className="mt-8">
      ...
      <div className="mx-auto max-w-6xl px-6 pb-12 space-y-12">
        <div className="grid gap-6 md:grid-cols-3">
          <LuxeCard title="Campaign Kits">
            Launch-ready content systems built around seasonal pushes and
            product drops—calendars, assets, and rollout guides.
          </LuxeCard>
          <LuxeCard title="Always-on Presence">
            Editorial storytelling, community engagement, and reporting
            delivered monthly with brand voice alignment.
          </LuxeCard>
          <LuxeCard title="Creator Collaborations">
            Talent sourcing, briefs, legal, and asset handoff handled end-to-end
            for influencer and partner campaigns.
          </LuxeCard>
        </div>

        <ProofStrip
          metric="Content engines shipping 120+ assets per quarter across seven platforms"
          logos={[]}
        />

        <div className="grid gap-6 md:grid-cols-2">
          <LuxeCard title="Channel expertise">
            Short-form video, carousel storytelling, email handoffs, and
            executive thought leadership optimized per platform.
          </LuxeCard>
          <LuxeCard title="Signal reporting">
            Creative performance dashboards, KPI tracking, and next-step
            roadmaps to keep learning cycles fast.
          </LuxeCard>
        </div>
          ...
          <div className="flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
            <div className="space-y-3 max-w-2xl">
              <h3 className="text-2xl font-semibold tracking-tight text-white">
                Campaign highlight placeholder
              </h3>
              <p className="text-neutral-300">
                Use this block for a social case study—include reach, engagement
                lift, follower growth, or sales impact once results are ready.
              </p>
            </div>
