...
const DigitalAssets: React.FC = () => {
  const assetPacks = [
    ...
    },
    {
      ...
      price: "$149",
      description:
        "High-resolution mylar bag mockups for product presentation.",
      tags: ["PSD", "PNG", "4K"],
      category: "Mockups",
      featured: true,
    },
      ...
      <div className="container mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-white/70 max-w-3xl mx-auto">
            Curated packs ready to download. Titles, descriptions, and tags
            shown as mock data.
          </p>
        </div>
            ...
            {[
              {
                ...
                description:
                  "Use in commercial projects, client work, and for-profit ventures.",
                icon: (
                  <svg
              ...
              },
              {
                ...
                description:
                  "No restrictions on the number of projects you can use assets in.",
                icon: (
                  <svg
                    className="w-8 h-8 text-white"
                    fill="none"
              ...
              },
              {
                ...
                description:
                  "Edit, modify, and customize assets to fit your brand needs.",
                icon: (
                  <svg
                    className="w-8 h-8 text-white"
                    fill="none"
