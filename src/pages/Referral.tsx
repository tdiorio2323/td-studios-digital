      ...
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-white/70 max-w-3xl mx-auto">
            Earn rewards by referring ambitious brands to our premium design
            services. Join our exclusive referral program and start earning
            today.
          </p>
        </div>
                ...
                <div className="space-y-6">
                  ...
                  <div className="text-center">
                    <p className="text-white/60 mb-4">
                      Share this link with teams who need elevated design and
                      earn commissions!
                    </p>
                    <button
                      onClick={() => {
                ...
                {[
                  {
                    ...
                    description:
                      "Sign up and get your unique referral link instantly.",
                  },
                  {
                    step: "02",
                    title: "Share with Brands",
                    description:
                      "Share your link with brands who need elevated design services.",
                  },
                  {
                    step: "03",
                    title: "They Purchase",
                  ...
                  },
                  {
                    ...
                    title: "Get Paid",
                    description:
                      "Receive your commission monthly via PayPal or bank transfer.",
                  },
                ].map((item, index) => (
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-20">
          {[
            ...
            <div
              key={index}
              className="text-center p-6 bg-white/5 backdrop-blur-md border border-white/10 rounded-xl"
            >
            ...
            {[
              {
                ...
                answer:
                  "Commissions are paid monthly on the 15th of each month for the previous month's sales.",
              },
              {
                question: "Is there a minimum payout?",
                answer:
                  "Yes, the minimum payout is $50. If you don't reach the minimum, your earnings roll over to the next month.",
              },
              {
                question: "How long do referral links last?",
                answer:
                  "Referral links never expire and provide lifetime tracking for all customers who use them.",
              },
              {
                question: "Can I refer myself?",
                answer:
                  "No, self-referrals are not allowed. The program is designed to reward genuine referrals from external sources.",
              },
            ].map((faq, index) => (
              <div
                key={index}
        ...
        <div className="text-center">
          <div className="max-w-4xl mx-auto p-12 bg-gradient-to-r from-white/10 to-white/5 backdrop-blur-lg border border-white/20 rounded-2xl">
            ...
            <p className="text-xl text-white/70 mb-8 max-w-2xl mx-auto">
              Join our referral program and start earning commissions by sharing
              our premium design services with visionary brands in your network.
            </p>
            <PremiumButton
